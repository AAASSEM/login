      ...
      <div className="flex flex-col items-stretch justify-center max-md:max-w-full">
        <div className="w-full max-md:max-w-full">
          ...
          <p className="text-sm font-normal mt-2 max-md:max-w-full">
            ...
            <span className="italic">just insights that matter</span>
            .
          </p>
        </div>
        <div className="text-sm font-normal mt-6">
          New user?{" "}
          <button className="underline text-[rgba(253,188,138,1)] hover:opacity-80 transition-opacity">
            Sign up
          </button>
        </div>
      </div>
      <img
        src="https://cdn.builder.io/api/v1/image/assets/05b1fd79d26f448994095c75ce8963d4/61d722d2222f3b6441dd952a357c1da2c8414dea?placeholderIfAbsent=true"
